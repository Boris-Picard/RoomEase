 ...
 */
final class Version20240826150235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT NOT NULL, users_id INT DEFAULT NULL, rooms_id INT NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, time TIME(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE room (id INT NOT NULL, name VARCHAR(200) NOT NULL, capacity INT NOT NULL, status VARCHAR(50) NOT NULL, equipment TEXT NOT NULL, PRIMARY KEY(id))');
